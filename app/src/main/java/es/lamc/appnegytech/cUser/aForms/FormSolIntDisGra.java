...
import es.lamc.appnegytech.databinding.FragmentFormSolIntDisGraBinding;

public class FormSolIntDisGra extends Fragment {

    private FragmentFormSolIntDisGraBinding binding;
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentFormSolIntDisGraBinding.inflate(inflater, container, false);
