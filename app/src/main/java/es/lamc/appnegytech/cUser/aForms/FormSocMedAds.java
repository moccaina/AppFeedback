...
import es.lamc.appnegytech.databinding.FragmentFormSocMedAdsBinding;

public class FormSocMedAds extends Fragment {

    private FragmentFormSocMedAdsBinding binding;
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentFormSocMedAdsBinding.inflate(inflater, container, false);
