...
import es.lamc.appnegytech.databinding.FragmentFormCreConBinding;

public class FormCreCon extends Fragment {

    private FragmentFormCreConBinding binding;
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentFormCreConBinding.inflate(inflater, container, false);
