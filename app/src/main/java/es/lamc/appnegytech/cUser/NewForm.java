...
import es.lamc.appnegytech.databinding.FragmentNewFormBinding;

public class NewForm extends Fragment {

    private FragmentNewFormBinding binding;
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentNewFormBinding.inflate(inflater, container, false);
