...
import es.lamc.appnegytech.databinding.FragmentFormBraBinding;

public class FormBra extends Fragment {

    private FragmentFormBraBinding binding;
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentFormBraBinding.inflate(inflater, container, false);
            ...
            if (servicioSeleccionado != null) {
                db.collection("lista_de_usuarios").document(uid)
                        ...
                        .addOnSuccessListener(documentSnapshot -> {
                            ...
                            datosFormulario.put("montoServicio", 0.00);
