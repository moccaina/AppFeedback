...
import es.lamc.appnegytech.databinding.FragmentFormBroDigBinding;

public class FormBroDig extends Fragment {

    private FragmentFormBroDigBinding binding;
    private View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentFormBroDigBinding.inflate(inflater, container, false);
